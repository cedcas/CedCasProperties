        ...
        headers: [
          {
            ...
            value: [
              ...
              // GA4 does NOT post hits to www.google-analytics.com only — it routes
              // them to regional endpoints (region1.google-analytics.com, …) and to
              // *.analytics.google.com. Naming just the www host blocks collection
              // at the network layer: gtag() runs without error and the beacon is
              // silently refused, so GA4 reports "No stream data detected" for every
              // event. Wildcards are Google's documented CSP guidance.
              ...
              "connect-src 'self' https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://api.stripe.com https://vercel.com https://*.public.blob.vercel-storage.com",
