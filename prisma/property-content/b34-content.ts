// Pure data — B34 (Cozy 1-Bedroom + Spacious 2-Bedroom) property SEO content.
// Deliberately has NO Prisma import and NO top-level side effects: it exists
// so this content can be imported by both prisma/seed-property-seo.ts (the
// seeding script) and scripts/fix-property-content.ts (the one-time
// production content-correction script) without either accidentally
// triggering the other's write routine. See DEC-016 for why this file exists.
type BestForSegment = {
  title: string;
  body: string;
...
export const TWO_BR: PropertySeoContent = {
  ...
  propertyFaqs: [
    ...
    },
    {
      ...
      answer:
        "Speed-tested at up to 340 Mbps, with a backup internet connection available. Multiple Netflix streams, video calls, kids' tablets — all simultaneously, no buffering.",
    },
    {
...
export const ONE_BR: PropertySeoContent = {
  slug: "cozy-1-bedroom",
  seoTitle:
    "Cozy 1BR Vacation Rental in Lipa City, Batangas — Fiber WiFi up to 340 Mbps | Haven in Lipa",
  seoDescription:
    "Cozy 1-bedroom vacation rental in Lipa City. Sleeps 5, full kitchen, fiber WiFi up to 340 Mbps, Netflix, solar power. ₱1,800/night. Book direct, save 15–20%.",
  ...
  propertyFaqs: [
    {
      ...
      answer:
        "Yes — fiber up to 340 Mbps, speed-tested by guests on multiple devices, with a backup internet connection available. Designed for remote work and multi-device streaming.",
    },
    {
