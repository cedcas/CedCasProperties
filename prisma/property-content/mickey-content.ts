// Pure data — B38 "Mickey in Lipa" (Sleeps 7/11/15) property SEO content.
// Deliberately has NO Prisma import and NO top-level side effects: it exists
// so this content can be imported by both prisma/seed-property-seo-mickey.ts
// (the seeding script) and scripts/fix-property-content.ts (the one-time
...
// ---------------------------------------------------------------------------
export const SLEEPS_7: PropertySeoContent = {
...
// ---------------------------------------------------------------------------
export const SLEEPS_11: PropertySeoContent = {
...
// ---------------------------------------------------------------------------
export const SLEEPS_15: PropertySeoContent = {
