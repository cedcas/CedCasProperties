...
const ONE_BR: PropertySeoContent = {
  ...
  heroSummary:
    "A one-bedroom vacation rental in a quiet gated village in Lipa City, Batangas — designed for couples, solo digital nomads, and small group stays. Sleeps up to 5, full kitchen, 400 Mbps fiber WiFi (speed-tested), Netflix Premium, solar-powered backup, and parking inside the village. ₱2,000 per night. Thirty-two verified guest reviews. One hour from Manila via SLEX/STAR Tollway.",
  description:
